...
class Client:
    ...
    def __generate_payload(self):
        return "DATA. Address {}:{}".format(self.ip_address, self.tcp_port)
...
class Hacker(Client):
    ...
    def receive(self, package):
        return self._build_answer(package, "Hacker connect")